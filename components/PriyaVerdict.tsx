...
export default function PriyaVerdict({ verdictText, tier, alternatives }: PriyaVerdictProps) {
  ...
  // Split text into paragraphs for chat bubble effect
    ...
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="space-y-3 ml-3">
        {paragraphs.map((para, i) => (
          ...
          >
            <div className="inline-block max-w-full bg-white border border-gray-100 rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex gap-2 mt-2">
                        {alt.flipkart_url && (
                          <a
                            href={alt.flipkart_url}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1 text-xs font-semibold text-white bg-[#FF6161] px-3 py-1.5 rounded-lg hover:opacity-90"
                          >
                        ...
                        {alt.amazon_url && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1 text-xs font-semibold text-white bg-[#FF9900] px-3 py-1.5 rounded-lg hover:opacity-90"
                          >
