...
import { Camera, Battery, Cpu, Monitor, Zap, Signal, HardDrive, Layers } from 'lucide-react'
...
export default function CompareTable({ phone1, phone2 }: CompareTableProps) {
  const specs = [
    ...
    },
    {
      ...
      plain1:
        phone1.price_inr < phone2.price_inr
          ? `₹${(phone2.price_inr - phone1.price_inr).toLocaleString('en-IN')} sasta`
          : undefined,
      plain2:
        phone2.price_inr < phone1.price_inr
          ? `₹${(phone1.price_inr - phone2.price_inr).toLocaleString('en-IN')} sasta`
          : undefined,
        ...
        {[
          ...
          <div
            ...
            className={`rounded-xl p-3 text-center border ${
              overallWinner === idx ? 'border-[#FF6B00] bg-orange-50' : 'border-gray-100 bg-white'
            }`}
          >
